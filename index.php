      ...
      <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
        <ul class="navbar-nav text-align">
          ...
          <li class="nav-item">
            ...
            <?php else : ?>
              <a class="nav-link active fw-medium" aria-current="page" href="pages/login.php" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">Produk</a>
            <?php endif; ?>
          </li>
          <li class="nav-item">
            <?php if (isLoggedIn()) : ?>
            ...
            <?php else : ?>
              <a class="nav-link active fw-medium" aria-current="page" href="pages/login.php" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">Tentang kami</a>
            <?php endif; ?>
          <li class="nav-item">
            <?php if (isLoggedIn()) : ?>
          ...
          <div class="col" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="1200">
            <div class="card h-100 shadow p-3">
              ...
              <div class="card-footer">
                ...
                <?php else : ?>
                  <a class="btn btn-success" href="pages/login.php" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">Selengkapnya</a>
                <?php endif; ?>
              </div>
            </div>
          </div>
